package com.jazzysoft.jpctsample.joystick;
...
public class JoystickView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (D) {
			...
			canvas.drawText("(" + String.format("%.0f, %.1f", radial, angle * 57.2957795) + (char) 0x00B0 + ")", handleX - 20, baseY + 15,
					dbgPaint2);
		}
	...
	private void reportOnMoved() {
		...
		if (this.moveListener != null) {
			...
			if (rx || ry) {
				...
				this.moveListener.OnMoved(userX, userY);
			}
		}
	}
